  ...
  return (
    <section id="closing" className="py-16 sm:py-24 text-center">
      ...
      <div className="flex gap-3 justify-center">
        ...
        <a href="#alchemilab" className="px-5 py-2.5 rounded-md border border-black/10 dark:border-white/15 text-sm hover:bg-black/5 dark:hover:bg-white/10">프로젝트 다시 보기</a>
      </div>
    </section>
  );
}
