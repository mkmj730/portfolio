  ...
  return (
    <section id="contact" className="py-14 sm:py-20">
      ...
      <div className="flex flex-wrap gap-3">
        <a href="mailto:mj@example.com" className="px-4 py-2 rounded-md border border-black/10 dark:border-white/15 hover:bg-black/5 dark:hover:bg-white/10 text-sm">이메일</a>
        ...
        <a href="/mj_resume.pdf" className="px-4 py-2 rounded-md bg-foreground text-background text-sm font-semibold hover:opacity-90">이력서 PDF</a>
      </div>
    </section>
  );
}
